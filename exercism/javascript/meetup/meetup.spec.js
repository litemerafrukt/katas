...
describe("meetupDay()", () => {
  test("test first sunday of september 2013", () => {
    expect(meetupDay(2013, 8, "Sunday", "1st")).toEqual(new Date(2013, 8, 1))
  })

  test("test first monday of september 2013", () => {
    expect(meetupDay(2013, 8, "Monday", "1st")).toEqual(new Date(2013, 8, 2))
  })
