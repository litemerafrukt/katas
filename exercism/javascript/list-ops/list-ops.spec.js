...
test("should be able to create a list from an array", () => {
  expect(new List(["not", "that", "what"]).values).toEqual(["not", "that", "what"])
})

test("should be able to create list from a list", () => {
  const list1 = new List(["not", "that", "what"])
  expect(new List(list1)).toEqual(list1)
})
