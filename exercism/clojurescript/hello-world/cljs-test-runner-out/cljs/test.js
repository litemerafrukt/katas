...
var G__3107 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__3107,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__3107;
}
}));
...
var len__4736__auto___3112 = arguments.length;
var i__4737__auto___3113 = (0);
while(true){
if((i__4737__auto___3113 < len__4736__auto___3112)){
args__4742__auto__.push((arguments[i__4737__auto___3113]));

var G__3114 = (i__4737__auto___3113 + (1));
i__4737__auto___3113 = G__3114;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq3109){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__3110,G__3111,seq3109__$2);
}));
...
var file = cljs.core.get.call(null,map__3116__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__3116__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__3116__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__3115_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__3115_SHARP_));
...
var temp__5735__auto___3118 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___3118)){
var message_3119 = temp__5735__auto___3118;
cljs.core.println.call(null,message_3119);
} else {
}
...
var temp__5735__auto___3120 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___3120)){
var message_3121 = temp__5735__auto___3120;
cljs.core.println.call(null,message_3121);
} else {
}
...
var output_dir__$1 = (function (){var G__3122 = output_dir;
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__3124 = exception.stack;
var G__3124__$1 = (((G__3124 == null))?null:clojure.string.split_lines.call(null,G__3124));
var G__3124__$2 = (((G__3124__$1 == null))?null:cljs.core.get.call(null,G__3124__$1,depth));
if((G__3124__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__3124__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__3125 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__3125,(0),null);
var column = cljs.core.nth.call(null,vec__3125,(1),null);
var vec__3128 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__3128,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__3128,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__3128,(2),null);
...
var m__$1 = (function (){var G__3131 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__3135 = (function (){var G__3134 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__3134);
} else {
return G__3134;
}
})();
...
return cljs.core.vary_meta.call(null,G__3136,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__3138 = e;
var G__3138__$1 = (((G__3138 instanceof cljs.core.Keyword))?G__3138.fqn:null);
switch (G__3138__$1) {
...
var vec__3140 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__3140,(0),null);
var types = vec__3140;
...
return cljs.core.map.call(null,(function (p__3143){
var vec__3144 = p__3143;
var ns = cljs.core.nth.call(null,vec__3144,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__3144,(1),null);
return (function (){
...
var G__3147 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__3147__$1 = (((G__3147 instanceof cljs.core.Keyword))?G__3147.fqn:null);
switch (G__3147__$1) {
case "async":
...
var seq__3148 = cljs.core.seq.call(null,vars__$1);
var chunk__3149 = null;
var count__3150 = (0);
var i__3151 = (0);
while(true){
if((i__3151 < count__3150)){
var v = cljs.core._nth.call(null,chunk__3149,i__3151);
var temp__5735__auto___3153 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___3153)){
var t_3154 = temp__5735__auto___3153;
each_fixture_fn.call(null,((function (seq__3148,chunk__3149,count__3150,i__3151,t_3154,temp__5735__auto___3153,v,each_fixture_fn,G__3147,G__3147__$1,env,once_fixtures,each_fixtures,vec__3144,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_3154)));
});})(seq__3148,chunk__3149,count__3150,i__3151,t_3154,temp__5735__auto___3153,v,each_fixture_fn,G__3147,G__3147__$1,env,once_fixtures,each_fixtures,vec__3144,ns,vars__$1))
);
} else {
}


var G__3155 = seq__3148;
var G__3156 = chunk__3149;
var G__3157 = count__3150;
var G__3158 = (i__3151 + (1));
seq__3148 = G__3155;
chunk__3149 = G__3156;
count__3150 = G__3157;
i__3151 = G__3158;
...
var temp__5735__auto__ = cljs.core.seq.call(null,seq__3148);
if(temp__5735__auto__){
var seq__3148__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__3148__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__3148__$1);
var G__3159 = cljs.core.chunk_rest.call(null,seq__3148__$1);
var G__3160 = c__4556__auto__;
var G__3161 = cljs.core.count.call(null,c__4556__auto__);
var G__3162 = (0);
seq__3148 = G__3159;
chunk__3149 = G__3160;
count__3150 = G__3161;
...
var v = cljs.core.first.call(null,seq__3148__$1);
var temp__5735__auto___3163__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___3163__$1)){
var t_3164 = temp__5735__auto___3163__$1;
each_fixture_fn.call(null,((function (seq__3148,chunk__3149,count__3150,i__3151,t_3164,temp__5735__auto___3163__$1,v,seq__3148__$1,temp__5735__auto__,each_fixture_fn,G__3147,G__3147__$1,env,once_fixtures,each_fixtures,vec__3144,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_3164)));
});})(seq__3148,chunk__3149,count__3150,i__3151,t_3164,temp__5735__auto___3163__$1,v,seq__3148__$1,temp__5735__auto__,each_fixture_fn,G__3147,G__3147__$1,env,once_fixtures,each_fixtures,vec__3144,ns,vars__$1))
);
} else {
}


var G__3165 = cljs.core.next.call(null,seq__3148__$1);
var G__3166 = null;
var G__3167 = (0);
var G__3168 = (0);
seq__3148 = G__3165;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__3147__$1)].join('')));
